        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-6 border-t border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm font-semibold text-gray-700">{point.best_season || 'Apr - Oct'}</div>
            </div>
          </div>
          ...
          {point.elevation_m && (
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm font-semibold text-gray-700">{point.elevation_m}m</div>
              </div>
            </div>
          )}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm font-semibold text-gray-700">{point.accessibility || 'Open Daily'}</div>
            </div>
          </div>
        </div>
